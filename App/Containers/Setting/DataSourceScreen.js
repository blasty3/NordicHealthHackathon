...
// Styles
class DataSourceScreen extends Component {
  constructor() {
    super()
    this.state = {
      personal: initData.PersonalDataSource,
      environment: initData.EnvironmentDataSource,
      hospital: initData.HospitalDataSource
    }
  }
  ...
  saveSetting () {
    this.props.setDataSource(this.state)
...
export default connect(mapStateToProps, mapDispatchToProps)(DataSourceScreen)
